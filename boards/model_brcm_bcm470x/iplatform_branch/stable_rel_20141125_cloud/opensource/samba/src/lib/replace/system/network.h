...
#include <ifaddrs.h>
/*
 * Added by TengFei, "ifaddrs.h" of some toolchains may define "struct ifaddrs"
 * but may be not define Macro HAVE_STRUCT_IFADDRS. like brcm.
 */
#ifndef HAVE_STRUCT_IFADDRS
#define HAVE_STRUCT_IFADDRS
