...
$.su.cloudError = function(errorcode){
	...
	switch(errorcode){
		...
		case "-50101":
			errorMsg = $.su.CHAR.ERROR["10000158"];
			break;
		case "-50102":
			errorMsg = $.su.CHAR.ERROR["10000159"];
			break;
		case "-50103":
			errorMsg = $.su.CHAR.ERROR["10000160"];
			break;
		case "-50111":
			errorMsg = $.su.CHAR.ERROR["10000161"];
			break;
		case "-50112":
			errorMsg = $.su.CHAR.ERROR["10000162"];
			break;
		case "-50121":
			errorMsg = $.su.CHAR.ERROR["10000164"];
			break;
		case "-50122":
			errorMsg = $.su.CHAR.ERROR["10000165"];
			break;
		case "-50131":
			errorMsg = $.su.CHAR.ERROR["10000167"];
			break;
		case "-50132":
			errorMsg = $.su.CHAR.ERROR["10000168"];
			break;
		case "-50140":
			errorMsg = $.su.CHAR.ERROR["10000169"];
			break;
		case "-51215": 
			errorMsg = $.su.CHAR.ERROR["10000140"];			
			break;
		default:
			errorMsg = $.su.CHAR.ERROR["10000191"];
	}
	return errorMsg;
};
