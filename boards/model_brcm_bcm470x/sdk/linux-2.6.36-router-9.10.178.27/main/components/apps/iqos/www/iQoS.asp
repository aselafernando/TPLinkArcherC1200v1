				...
				<div>
					...
					<div id="iQoSDataTransferDetails" class="iQoSDataTransferDetails iQoSSystemDetails">
						<table class= "datatransferdetails">
							...
							<tr> <td>Uplink Bandwidth Available on Network: </td> </tr>
							<tr> <td>Total data Downloaded in last Session: </td> </tr>
							<tr> <td>Total data Uploaded in last Session: </td> </tr>
						</table>
					</div>
				</div>
			</p>
					...
					<tr>
						...
						<td width=50%>
							<div class="AppBandwidthHeading">
								<table class="appselectedtbl1" align="left"><tr><td>Bandwidth Usage by Applications (Mbps)</td></tr></table>
							</div>
						</td>
					</tr>
					<tr>
