...
extern u16 vlan_dev_vlan_egress_prio(const struct net_device *dev, u32 skb_prio);
...
/*
**	Wraper routine of "__find_vlan_dev()", will export symbol to public.
@@	TengFei, Oct 23th, 2014
*/
...
@@	TengFei, Oct 23th, 2014
*/
static inline struct net_device *find_vlan_dev(struct net_device *real_dev, u16 vlan_id)
{
	return NULL;
}
#endif
