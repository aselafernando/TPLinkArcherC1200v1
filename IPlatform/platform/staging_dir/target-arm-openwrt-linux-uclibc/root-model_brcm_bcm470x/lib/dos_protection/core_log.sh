...
#
# /lib/dos-protection/core_log.sh
# Written by Huluyao <huluyao@tp-link.com.cn>, June 2014
#
# This script is used to make tp-link log of dos-protection
DOS_PROTECTION_MOD_ID=249

DOS_PROTECTION_LOG_DBG_BLOCK_LIST_ADD=11

DOS_PROTECTION_LOG_INF_FLUSH_CT=21

DOS_PROTECTION_LOG_WNG_CFG_NOT_SUPPORT=41

DOS_PROTECTION_LOG_WNG_FIREWALL_NOT_LOADED=42
...
syslog() {
    local log_id=$1
    shift
    logx -p $$ $DOS_PROTECTION_MOD_ID $log_id "$@"
}